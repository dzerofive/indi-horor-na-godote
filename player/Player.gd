...
export var mouse_sensitivity : Vector2 = Vector2(.3, .3) 
export(float, 0.0, 1.0) var mouse_acceleration : float = 0.1 
...
export var forward_action = "move_fw"
export var backwards_action = "move_bw"
export var left_action = "move_lt"
export var right_action = "move_rt"
